...
local EGG_PRIORITY_GROUPS = {
    ...
    {
        "Amethyst Egg", "Ruby Eg", "Emerald Eg"
    },
    
    -- Группа 2 (средний приоритет) — добавили "Primo Egg", исправили "Werewolf Eg" → "Werewolf Egg"
    {
        "Werewolf Egg", 
        "SigmaBloxian Eg", 
        "Delicious Eg", 
    ...
    -- Группа 3 (низкий приоритет) — все из нового списка, кроме тех, что уже в 1 или 2
    {
    }
}
...
local function updateEggSpeed()
    ...
    if playerHumanoidFolder and playerHumanoidFolder:FindFirstChild("Humanoid") then
        ...
        EGG_SPEED = 16 -- Резервная скорость
    end
end
